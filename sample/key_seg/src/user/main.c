...
void key_proc() {
	...
	if (is_down(4) || is_down(12)) {
		led_buf[0] = !led_buf[0];
	}
	if (is_down(5) || is_down(13)) {
		led_buf[1] = !led_buf[1];
	}
	if (is_down(6) || is_down(14)) {
		led_buf[2] = !led_buf[2];
	}
	if (is_down(7) || is_down(15)) {
		led_buf[3] = !led_buf[3];
	}
	if (is_down(8) || is_down(16)) {
		led_buf[4] = !led_buf[4];
	}
	if (is_down(9) || is_down(17)) {
		led_buf[5] = !led_buf[5];
	}
	if (is_down(10) || is_down(18)) {
		led_buf[6] = !led_buf[6];
	}
	if (is_down(11) || is_down(19)) {
		led_buf[7] = !led_buf[7];
	}
}
